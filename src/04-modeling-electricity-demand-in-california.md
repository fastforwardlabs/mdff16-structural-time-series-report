...
![Figure: There are many possible applications for good forecasts of electricity demand.](/figures/ff16-09.png)
...
![Figure: Observed electricity demand (orange) against the baseline demand forecast (green) for 2019.](figures/baseline.png)
...
![Figure: Observed electricity demand (orange) against the demand forecast generated by a simple Prophet model (green) for 2019. Notice that the (default) Prophet model fails to capture the increased variance in summer.](figures/prophet-simple.png)
...
![Figure: Scatter plot of the forecast demand against the true demand. Especially for higher demand, the model is underpredicting, which is consistent with not capturing the increased variance in summer.](figures/scatter.png)
...
![Figure: A histogram of the residuals (the true demand minus the forecast demand).](figures/histogram.png)
...
![Figure: The autocorrelation up to 48 hours. Clearly, there is a strong correlation between timesteps our model does not capture. The orange bands illustrate the 95% confidence interval for the null hypothesis of no autocorrelation.](figures/autocorrelation.png)

![Figure: The partial autocorrelation. This is the autocorrelation with the effects of previous timesteps removed. The orange bands illustrate the 95% confidence interval for the null hypothesis of no partial autocorrelation.](figures/partial-autocorrelation.png)
...
We can improve this by changing the structure of the model.
...
![Figure: Observed electricity demand (orange) against the demand forecast generated by an improved Prophet model (green) for 2019.](figures/prophet-complex.png)
...
![Figure: Observed electricity demand (orange) against the demand forecast generated by the final model (green) for 2019.](figures/prophet-complex-log.png)
...
![Figure: A probabilistic forecast allows us to ask and answer smarter questions than we can with point estimates.](figures/ff16-10.png)
